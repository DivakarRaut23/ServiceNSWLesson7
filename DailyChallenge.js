const getRandomGivenName = function () {
    const RANDOM_FIRST_NAMES = ["Divakar", "Zlatan","David","Juan","Azamat","Borat","Hari Bahadur", "Bhasme", "Pande","Anthony","Marcus","Jose"];
    return RANDOM_FIRST_NAMES[Math.floor(Math.random() * RANDOM_FIRST_NAMES.length)];
}

const getRandomFamilyName = function () {
    const RANDOM_LAST_NAMES = ["Mourhino", "Pokharel", "Ibrahimovic", "Timalsina", "Raut", "Silwal", "Chaulagain", "Joshi", "Shrestha", "Pradhan", "Bhagatov", "Dhungana"];
