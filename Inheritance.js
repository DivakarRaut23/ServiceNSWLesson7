...
class Daschund extends Dog {
    constructor (name, age) {
        super(name, age, "Daschund");
    }
    // getInfo() {
    //     return super.getInfo() + "Daschund are so cute!";
    // }
}

let cat = new Pet ("Fabbie", 5, "Cat");
let paat = new Dog ("Pattu", 6, "Shepherd");
let daschund = new Daschund ("Morphie", 4);
